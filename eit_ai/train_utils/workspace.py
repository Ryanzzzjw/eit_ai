...
from eit_ai.train_utils.lists import ListModelHandlers, ListDatasetHandlers
...
class AiWorkspace(ABC):
    ...
    def select_model_dataset(
        self,
        model_type:ListModelHandlers=None,
        dataset_type:ListDatasetHandlers=None,
        metadata:MetaData=None)-> None:
        """Set the model_manager and the dataset, from Lists defined for each
        workspaces type (keras, pythorch, ...)
